...
class paypal_ipn
{
	...
	function get_payment_status() {
		$payment_status = isset($this->paypal_post_vars['payment_status']) ? $this->paypal_post_vars['payment_status'] : "";
	...
	function error_out($message, $em_headers)
	{
		...
		mail($this->error_email, "[$date] paypal_ipn notification", $message, $em_headers);
